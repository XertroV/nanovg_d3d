...
fxc.exe /Fh D3D9PixelShader.h /T ps_3_0 /E D3D9PixelShader_Main D3D9PixelShader.hlsl; fxc.exe /Fh D3D9PixelShaderAA.h /T ps_3_0 /E D3D9PixelShaderAA_Main D3D9PixelShaderAA.hlsl; fxc.exe /Fh D3D9VertexShader.h /T vs_3_0 /E D3D9VertexShader_Main D3D9VertexShader.hlsl
