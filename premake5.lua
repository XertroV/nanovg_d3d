...
solution "nanovg"
	...
	project "example_d3d9"
		kind "ConsoleApp"
		language "C"
		files { "example/example_d3d9.c", "example/demo.c", "example/perf.c" }
		includedirs { "src", "example" }
		targetdir("build")
		links { "nanovg" }

		configuration { "windows" }
			 links { "d3d9", "gdi32", "winmm", "user32", "kernel32" }
			 defines { "NANOVG_D3D9", "_CRT_SECURE_NO_WARNINGS" }
